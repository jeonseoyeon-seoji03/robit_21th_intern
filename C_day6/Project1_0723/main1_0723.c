/*과제 1은 4일차 과제 7과 같은 과제로, 제출하지 않아도 된다고 하셨으나,
다음 과제인 2,3 번에서 아래 코드와 연계된 내용을 구현해야한다는 점에서
참고용으로 4일차의 과제를 가져와 작성한 것이니 건너뛰시면 됩니다.*/ 
...
typedef struct {
    ...
    Node* tail;
    int size;
} LinkedList;// 4일차 과제 7번에서 제시된 구조체 사용
